...
<form id="loginForm" action="user" method="post" onsubmit="return login();">
	...
	<div><label for="uid">아이디</label><input type="text" id="uid" name="uid" value="test01"></div>
	<div><label for="pwd">암 호</label><input type="password" id="pwd" name="pwd" value="test01"></div>
	<div><button type="reset">취소</button>
		<button type="submit">로그인</button>
	</div>
</form>
<div class="link_user">[<a href="user?cmd=edit">회원정보 변경</a>]</div>|
<div class="link_user">[<a href="bbs?cmd=index">게시판 메뉴로 이동</a>]</div>
</main>
</body>
</html>
